...
@section('content')
    ...
    <div class="authentication-wrapper authentication-basic container-p-y">
        <div class="authentication-inner py-4">
            <div class="card p-2">
                ...
                <div class="app-brand justify-content-center mt-5">
                    <a href="index.html" class="app-brand-link gap-2">
                        ...
                        <span class="app-brand-text demo text-heading fw-bold">WanponDev</span>
                    </a>
                </div>
                <!-- /Logo -->
                <!-- Reset Password -->
                <div class="card-body mt-2">
                    ...
                    <form id="formAuthentication" class="mb-0" action="{{ route('password.email') }}" method="POST">
                        @csrf
            ...
            <img
                alt="mask"
                src="{{ asset('assets/img/illustrations/auth-basic-forgot-password-mask-light.png') }}"
